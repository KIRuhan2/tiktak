      ...
      <div :class="['sidepanel', settings.status ? 'sidepanel--active' : '']">
        <div class="sidepanel__content">
          <div class="sidepanel__option">
              <div class="sidepanel__option__item">Cell Size <span class ="default" @click="fieldSettings.cellSize = defaultCellSize()">Default</span></div>
              <div class="sidepanel__option__row">
                <input class = "cellSizeValue" v-model.number="fieldSettings.cellSize" type="range" min="20" max="200" value="100">
...
export default {
  ...
  methods: {
    ...
    resetGame () {
      ...
      if(this.predictMatrixSize && this.predictMatrixSize <= 20 && this.predictMatrixSize >= 3)
        this.fieldSettings.matrixSize = this.predictMatrixSize
